...
namespace DFC.App.JobProfileTasks.MessageFunctionApp.UnitTests.Services
{
    public class HttpClientServicePatchTests
    {
        ...
        public async Task PatchAsyncReturnsOkStatusCodeForExistingId()
        {
            ...
            // act
            var result = await httpClientService.PatchAsync(A.Fake<PatchEnvironmentsModel>(), "endpoint").ConfigureAwait(false);
        ...
        public async Task PatchAsyncReturnsExceptionForBadStatus()
        {
            ...
            // act
            var exceptionResult = await Assert.ThrowsAsync<HttpRequestException>(async () => await httpClientService.PatchAsync(A.Fake<PatchEnvironmentsModel>(), "endpoint").ConfigureAwait(false)).ConfigureAwait(false);
